    ...
    DROP PROCEDURE [dbo].[spGetTracciatureOdls]

    GO
    ALTER TABLE OrdiniDiLavoro ADD OrdinamentoProd bigint NULL 
    ALTER TABLE [dbo].[OrdiniDiLavoro] ADD  CONSTRAINT [DF_OrdiniDiLavoro_OrdinamentoProd_1]  DEFAULT ((0)) FOR [OrdinamentoProd]


    ALTER TABLE ArticoliFasi ADD NoteAttrezzaggio nvarchar(max) NULL


    ALTER TABLE Attrezzi ADD PathImmagine nvarchar(max) NULL


    ALTER TABLE Configurazioni DROP CONSTRAINT DF_Configurazioni_FlGenerazioneLotti
    ALTER TABLE [dbo].[Configurazioni] ADD  CONSTRAINT [DF_Configurazioni_FlGenerazioneLotti_1]  DEFAULT ((0)) FOR [FlGenerazioneLotti]

    ALTER TABLE Configurazioni DROP CONSTRAINT DF_Configurazioni_FormatoGenerazioneLotti
